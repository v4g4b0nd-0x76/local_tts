...
(function (global) {
  ...
  class LocalTTSPDFJSReader {
    ...
    _installStyle() {
      ...
      style.textContent = `.textLayer .${ACTIVE_CLASS} { background: var(--local-tts-highlight, rgba(183, 53, 53, .48)) !important; box-shadow: 0 0 0 1px var(--local-tts-highlight-outline, rgba(217, 74, 74, .55)); border-radius: 2px; } .local-tts-status { margin-left: 8px; font-size: 12px; } .local-tts-progress { width: 96px; margin: 0 4px; vertical-align: middle; }`;
